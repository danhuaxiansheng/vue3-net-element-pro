...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('network-pro-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName(
          'body'
        )[0].className = `network-pro-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`network-pro-theme-${name}`)
        localStorage.removeItem('network-pro-theme')
